    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>CAS PRATIQUE</span></a>
            </div>
        </div>
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Liste Endroit</h4>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <button id="addToTable" class="btn btn-success waves-effect waves-light" onclick="add_endroit()"><i class="fa fa-plus"></i>Nouveau endroit </button>
        ...
        <div class="contact-list nicescroll">
            <ul class="list-group contacts-list">
                <li class="list-group-item">
                    <a href="#">
                        <div class="avatar">
                            <img src="<?php base_url()?>assets/images/users/avatar-11.jpg" alt="">
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Endroit/list_endroit')?>",
                "type": "POST"
            },
    ...
    function add_endroit()
    {
        ...
        $('.modal-title').text('Nouvelle endroit'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_endroit(endroit_id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Endroit/update_endroits/')?>/" + endroit_id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('.modal-title').text('Edition Endroit'); // Set title to Bootstrap modal title
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('Endroit/ajout_endroits')?>";
        } else {
            url = "<?php echo site_url('Endroit/update_endroits')?>";
        }
    ...
    function delete_endroit(endroit_id)
    {
        if(confirm('Vous-le vous vraiment supprimer '))
        {
            // ajax delete data to database
            $.ajax({
                url : "<?php echo site_url('Endroit/delete_endroits')?>/"+endroit_id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="coef" placeholder="designation" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
