                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button id="addToTable" class="btn btn-success waves-effect waves-light" onclick="add_user()">Nouveau utilisateur <i class="fa fa-plus"></i></button>
                            </div>
...
<script type="text/javascript">
    ...
    function add_user()
    {
        ...
        $('.modal-title').text('Add Utilisateur'); // Set Title to Bootstrap modal title
    ...
    function edit_user(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Utilisateur/ajax_edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="date_anniversaire"]').datepicker('update',data.date_anniversaire);
    ...
    function delete_user(id)
    {
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo site_url('Utilisateur/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        <div class="modal-content p-0 b-0">
            <div class="panel panel-color panel-primary">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Modification Utilisateur</h3>
                </div>
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="nom" placeholder="Veuillez saisir votre nom" class="form-control" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="email" placeholder="Veuillez saisir votre email" class="form-control" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="date_anniversaire" placeholder="yyyy-mm-dd" class="form-control datepicker" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
