                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <button id="addToTable" class="btn btn-success waves-effect waves-light" onclick="add_user()"><i class="fa fa-plus"></i>  Nouveau Utilisateur</button>
        ...
        <div class="contact-list nicescroll">
            <ul class="list-group contacts-list">
                ...
                <li class="list-group-item">
                    <a href="#">
                        <div class="avatar">
                            <img src="<?php base_url()?>assets/images/users/avatar-4.jpg" alt="">
                        </div>
                ...
                <li class="list-group-item">
                    <a href="#">
                        <div class="avatar">
                            <img src="<?php base_url()?>assets/images/users/avatar-6.jpg" alt="">
                        </div>
                ...
                <li class="list-group-item">
                    <a href="#">
                        <div class="avatar">
                            <img src="<?php base_url()?>assets/images/users/avatar-9.jpg" alt="">
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tb = $('#tb').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Utilisateur/list_user')?>",
                "type": "POST"
            },
    ...
    function add_user()
    {
        ...
        $('.modal-title').text('Nouvelle utilisateur'); // Set Title to Bootstrap modal title
    }

    function edit_person(utilisateur_id)
    {
        save_method = 'update';
        $('#form')[0].reset(); // reset form on modals
        $('.form-group').removeClass('has-error'); // clear error class
        ...
        $.ajax({
            url : "<?php echo site_url('Utilisateur/edit_users/')?>/" + utilisateur_id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="data_anniversaire"]').datepicker('update',data.data_anniversaire);
                $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Modification Utilisateur'); // Set title to Bootstrap modal title
    ...
    {
        tb.ajax.reload(null,false); //reload datatable ajax
    }
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('Utilisateur/ajout_users')?>";
        } else {
            url = "<?php  echo site_url('Utilisateur/update_users')?>";
        }
    ...
    function delete_user(utilisateur_id)
    {
        if(confirm('Vous-le vous vraiment supprimer '))
        {
            // ajax delete data to database
            $.ajax({
                url : "<?php echo site_url('Utilisateur/delete_users')?>/"+utilisateur_id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="utilisateur_id" placeholder="id" class="form-control" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input name="nais" placeholder="yyyy-mm-dd" class="form-control datepicker" type="text">
                                    <span class="help-block"></span>
                                </div>
                            </div>
                        </div>
